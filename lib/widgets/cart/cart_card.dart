      ...
      child: Stack(
        children: [
          Row(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Image.network(document['productImage'],fit: BoxFit.contain,),
            ),
          ),
              Container(
                child: Column(
                  ...
                  children: [
                    ...
                    if(document['comparedPrice']>0)
                      Text(document['comparedPrice'].toStringAsFixed(0),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text('₹ ${saving.toStringAsFixed(0)}',style: TextStyle(color: Colors.white),),
