                ...
                AbsorbPointer(
                  ...
                  child: OutlinedButton(
                    ...
                    onPressed: (){
                      ...
                      _coupon.getCouponDetails(_couponText.text, widget.couponVendor).
                      then((value) {
    ...
    showCupertinoDialog(
        ...
        builder: (BuildContext context){
          return CupertinoAlertDialog(
            ...
            content: Text('This discount $code you have entered is $validity. Please try with another code'),
         actions: [
