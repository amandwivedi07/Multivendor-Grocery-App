...
class _NearByStoresState extends State<NearByStores> {
  ...
  refreshedChangeListener=PaginateRefreshedChangeListener();
    ...
    return Container(
      ...
      child: StreamBuilder<QuerySnapshot>(
        ...
        builder: (BuildContext context,AsyncSnapshot<QuerySnapshot>snapShot){
            ...
            shopDistance.sort(); //this will sort nearest distance
            ...
            if(shopDistance[0]>  1000000 )
            {
              ...
              return Container(
                ...
                child: Container(
                    child: Center(child:
                    Text('Currently we are not servicing in your area, Please try later or try another location ',
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('©Aman Dwivedi',style: TextStyle(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                document['dialog'],style: kstoreCardStyle,
                              ),
                              SizedBox(
                                height: 3,
                              ),
                              Container(
                                ...
                                child: Text(
                                    document['address'],style: kstoreCardStyle,
                                  overflow: TextOverflow.ellipsis,
                                ),
                              ),
                              SizedBox(
                              ...
                              Row(
                                // this is rating will work on later
                                children: [
                                  Icon(
                                    Icons.star,
                                    size: 12,
                    ...
                    Padding(
                      ...
                      child: Container(
                        child: Stack(
                          children: [
                            Center(
                              child: Text('***Thats\s all folks****',style: TextStyle(
                                color: Colors.grey,),),
                              ),
                            Image.asset('images/city.png',color: Colors.black12,),
                            Positioned(
