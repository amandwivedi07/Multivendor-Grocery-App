...
import 'package:multi/services/product_services.dart';
...
class _ProductFilterWidgetState extends State<ProductFilterWidget> {
  ...
  void didChangeDependencies() {
    ...
    FirebaseFirestore.instance
        .collection('products')
        .where('category.mainCategory',isEqualTo: _store.selectedProductsCategory)
        .get()
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DocumentSnapshot>(
      ...
      future: _services.category.doc(_storeData.selectedProductsCategory).get(),
            ...
            scrollDirection: Axis.horizontal,
              children: [
                ...
                ActionChip(
                  ...
                  label: Text(
                      'All ${_storeData.selectedProductsCategory}'),
                    onPressed: (){
                ...
                ListView.builder(
                  ...
                  itemBuilder: (BuildContext context,int index ){
                    ...
                    itemCount: data.length.compareTo(0)
                )
              ],
