...
//Now we need to show on store in 10 km direction
          //Need to confirm even shop near by or not
          List shopDistance=[];
                    ...
                    child: Row(
                      children: [
                       SizedBox(
                        ...
                        Text('Top Picked For You',style: TextStyle(fontWeight: FontWeight.w900,fontSize: 12),),
                      ],
                    ),
                  ),
                  Flexible(
                    child: ListView(
                      ...
                      children: snapShot.data.docs.map((DocumentSnapshot document){
                        ...
                        if(double.parse(getDistance(document['location']))<=100000){
                          //Show the store within 10km only
                          //you can increase or decrease the distance
                          return InkWell(
                            onTap: (){
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${getDistance(document['location'])}km',style: TextStyle(color: Colors.grey,fontSize: 10),)
